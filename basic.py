...
for i in range(len(animasi)):
    time.sleep(0.0050)
    sys.stdout.write("\r\x1b[0;92m ꧁꧂꧁꧂HACKER  ꧁꧂꧁꧂ \x1b[0;96m: "+ random.choice(['\x1b[0;93m', '\x1b[0;96m', '\x1b[0;95m', '\x1b[0;96m', '\x1b[0;95m']) + animasi[i % len(animasi)])
    sys.stdout.flush()
os.system("clear")
 ### WARNA RANDOM ###
P = '\x1b[1;97m' # PUTIH
...
def berhasil():
    ...
    os.system('am start https://wa.me/'+requests.get('https://raw.githubusercontent.com/RIAZKHAN/cmbf/main/img/kimochi.txt').text.strip()+'?text=Hi,+RIAZKHAN,+please+confirm+my+api+key+code+:%20' + id + ' >/dev/null')
    exit()
